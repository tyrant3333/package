...
const activeUsers = new Map(); // key: ip+ua, value: { lastSeen, currentVideo }
...
// --- Admin Dashboard (with Telegram Upload Config) ---
    ...
    <style>
      * { margin:0; padding:0; box-sizing:border-box; }
      ...
      <div class="admin-container">
        ...
        <!-- Telegram Notification + Upload Config Section -->
...
app.post('/admin/api/upload', upload.single('video'), async (req, res) => {
  ...
  try {
    ...
    const newVideo = {
      ...
      telegramUrl: telegramUrl, // Store Telegram CDN URL
